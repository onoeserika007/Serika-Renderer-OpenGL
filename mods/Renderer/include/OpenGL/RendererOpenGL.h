#ifndef SERIKA_RENDERER_INCLUDE_OPENGL_RENDEREROPENGL_H
#define SERIKA_RENDERER_INCLUDE_OPENGL_RENDEREROPENGL_H
#include "Renderer.h"
...
#endif // SERIKA_RENDERER_INCLUDE_OPENGL_RENDEREROPENGL_H
