#ifndef SERIKA_RENDERER_INCLUDE_OPENGL_ENUMSOPENGL_H
#define SERIKA_RENDERER_INCLUDE_OPENGL_ENUMSOPENGL_H
...
#endif // SERIKA_RENDERER_INCLUDE_OPENGL_ENUMSOPENGL_H
