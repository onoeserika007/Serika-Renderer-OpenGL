#ifndef SERIKA_RENDERER_INCLUDE_OPENGL_FRAMEBUFFEROPENGL_H
#define SERIKA_RENDERER_INCLUDE_OPENGL_FRAMEBUFFEROPENGL_H
...
#endif // SERIKA_RENDERER_INCLUDE_OPENGL_FRAMEBUFFEROPENGL_H
