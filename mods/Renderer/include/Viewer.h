#ifndef SERIKA_RENDERER_INCLUDE_VIEWER_H
#define SERIKA_RENDERER_INCLUDE_VIEWER_H
#include <memory>
#include "FCamera.h"
...
public:
	...
	void init(void *window, int width, int height, int outTexId, Application* app = nullptr);
...
#endif // SERIKA_RENDERER_INCLUDE_VIEWER_H
