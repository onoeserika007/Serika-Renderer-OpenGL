#ifndef SERIKA_RENDERER_INCLUDE_RENDERPASS_RENDERPASS_H
#define SERIKA_RENDERER_INCLUDE_RENDERPASS_RENDERPASS_H
...
#endif // SERIKA_RENDERER_INCLUDE_RENDERPASS_RENDERPASS_H
